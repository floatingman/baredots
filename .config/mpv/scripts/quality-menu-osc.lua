...
function window_controls(topbar)
	...
	sh_area_y1 = wc_geo.y + get_align(1 - (2 * user_opts.deadzonesize), osc_param.playresy - wc_geo.y, 0, 0)
...
function bar_layout(direction)
	...
	if direction > 0 then
		-- deadzone below OSC
		sh_area_y0 = user_opts.barmargin
		sh_area_y1 = osc_geo.y + get_align(1 - (2 * user_opts.deadzonesize), osc_param.playresy - osc_geo.y, 0, 0)
	else
		-- deadzone above OSC
